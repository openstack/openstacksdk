...
class TestGroup(base.BaseBlockStorageTest):
    ...
    def setUp(self):
        ...
        volume_types = list(self.admin_block_storage_client.types())
        self.volume_type = volume_types[0]

        group_type_name = self.getUniqueString()
        self.group_type = self.admin_block_storage_client.create_group_type(
        ...
        self.group = self.admin_block_storage_client.create_group(
            name=group_name,
    ...
    def tearDown(self):
        ...
        # the group type
        self.admin_block_storage_client.delete_group(
            self.group, delete_volumes=True
        )
        self.admin_block_storage_client.wait_for_delete(self.group)

        self.admin_block_storage_client.delete_group_type(self.group_type)
        self.admin_block_storage_client.wait_for_delete(self.group_type)

        super().tearDown()

    def test_group_type(self):
        # get
        group_type = self.admin_block_storage_client.get_group_type(
            self.group_type.id
        )
        ...
        # list
        group_types = list(self.admin_block_storage_client.group_types())
        ...
        group_type = self.admin_block_storage_client.update_group_type(
            self.group_type,
            name=group_type_name,
    ...
    def test_group_type_group_specs(self):
        # create
        group_type = (
            self.admin_block_storage_client.create_group_type_group_specs(
                self.group_type,
                {'foo': 'bar', 'acme': 'buzz'},
            )
        )
        ...
        # get
        spec = self.admin_block_storage_client.get_group_type_group_specs_property(  # noqa: E501
            self.group_type,
            'foo',
        )
        ...
        # update
        spec = self.admin_block_storage_client.update_group_type_group_specs_property(  # noqa: E501
            self.group_type,
            'foo',
            'baz',
        )
        ...
        # delete
        self.admin_block_storage_client.delete_group_type_group_specs_property(
            self.group_type,
            'foo',
        )
        group_type = self.admin_block_storage_client.get_group_type(
    ...
    def test_group(self):
        # get
        group = self.admin_block_storage_client.get_group(self.group.id)
        ...
        # list
        groups = self.admin_block_storage_client.groups()
        ...
        group = self.admin_block_storage_client.update_group(
            self.group,
            name=group_name,
    ...
    def test_group_snapshot(self):
        ...
        self.volume = self.admin_block_storage_client.create_volume(
            name=volume_name,
        ...
        self.group_snapshot = (
            self.admin_block_storage_client.create_group_snapshot(
        ...
        # get
        group_snapshot = self.admin_block_storage_client.get_group_snapshot(
        ...
        # list
        group_snapshots = self.admin_block_storage_client.group_snapshots()
        ...
        # delete
        self.admin_block_storage_client.delete_group_snapshot(
            self.group_snapshot
        )
        self.admin_block_storage_client.wait_for_delete(self.group_snapshot)
