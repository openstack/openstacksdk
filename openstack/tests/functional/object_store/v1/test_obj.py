...
class TestObject(base.BaseFunctionalTest):
    ...
    def test_list(self):
        names = [
            o.name
            for o in self.operator_cloud.object_store.objects(
    ...
    def test_download_object(self):
        result = self.operator_cloud.object_store.download_object(
    ...
    def test_system_metadata(self):
        # get system metadata
        obj = self.operator_cloud.object_store.get_object_metadata(
            self.FILE, container=self.FOLDER
        )
        ...
        self.operator_cloud.object_store.delete_object_metadata(
