...
class TestFlavor(base.BaseComputeTest):
    def setUp(self):
        super().setUp()
    ...
    def test_flavor(self):
        ...
        public_flavor = self.admin_compute_client.create_flavor(
        ...
        private_flavor = self.admin_compute_client.create_flavor(
        ...
        flavors = list(self.admin_compute_client.flavors())
        ...
        flavor = self.admin_compute_client.get_flavor(public_flavor.id)
        ...
        self.admin_compute_client.update_flavor(
            public_flavor,
    ...
    def test_flavor_access(self):
        ...
        self.admin_compute_client.flavor_add_tenant_access(
        ...
        self.admin_compute_client.flavor_remove_tenant_access(
            flavor.id, project['id']
        )
    ...
    def test_flavor_extra_specs(self):
        ...
        specs = {'a': 'b'}
        self.admin_compute_client.create_flavor_extra_specs(
            flavor, extra_specs=specs
        )

        # verify specs were created correctly

        flavor_with_specs = self.admin_compute_client.fetch_flavor_extra_specs(
            flavor
        )
        ...
        self.admin_compute_client.update_flavor_extra_specs_property(
            flavor, 'c', 'd'
        )

        # fetch single property value

        prop_value = self.admin_compute_client.get_flavor_extra_specs_property(
            flavor, 'c'
        )
        ...
        self.admin_compute_client.delete_flavor_extra_specs_property(
            flavor, 'c'
        )
