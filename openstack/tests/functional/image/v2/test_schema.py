...
class TestSchema(base.BaseImageTest):
    def test_get_images_schema(self):
        schema = self.admin_image_client.get_images_schema()
        self.assertIsNotNone(schema)
        self.assertIsInstance(schema, _schema.Schema)

    def test_get_image_schema(self):
        schema = self.admin_image_client.get_image_schema()
        self.assertIsNotNone(schema)
        self.assertIsInstance(schema, _schema.Schema)

    def test_get_members_schema(self):
        schema = self.admin_image_client.get_members_schema()
        self.assertIsNotNone(schema)
        self.assertIsInstance(schema, _schema.Schema)

    def test_get_member_schema(self):
        schema = self.admin_image_client.get_member_schema()
        self.assertIsNotNone(schema)
        self.assertIsInstance(schema, _schema.Schema)
