...
class TestMetadefObject(base.BaseImageTest):
    def setUp(self):
        ...
        self.metadef_object = self.admin_image_client.create_metadef_object(
            name=object,
    ...
    def tearDown(self):
        self.admin_image_client.delete_metadef_object(
            self.metadef_object,
            self.metadef_object.namespace_name,
        )
        self.admin_image_client.wait_for_delete(self.metadef_object)
    ...
    def test_metadef_objects(self):
        # get
        metadef_object = self.admin_image_client.get_metadef_object(
        ...
        metadef_objects = list(
            self.admin_image_client.metadef_objects(
                self.metadef_object.namespace_name
            )
        )
        ...
        metadef_object = self.admin_image_client.update_metadef_object(
            self.metadef_object.name,
