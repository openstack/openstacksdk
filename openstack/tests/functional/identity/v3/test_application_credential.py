...
class TestApplicationCredentials(base.BaseIdentityTest):
    ...
    def test_get_application_credential(self):
        app_creds = self._create_application_credentials()
        app_cred = self.admin_identity_client.get_application_credential(
    ...
    def test_application_credentials(self):
        ...
        app_creds = self.admin_identity_client.application_credentials(
            user=self.user_id
        )
    ...
    def test_delete_application_credential(self):
        ...
        self.assertRaises(
            ...
            self.admin_identity_client.get_application_credential,
            user=self.user_id,
