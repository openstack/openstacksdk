...
class TestLoadBalancer(base.BaseFunctionalTest):
    ...
    def setUp(self):
        ...
        test_flavor_profile = (
            self.operator_cloud.load_balancer.create_flavor_profile(
        ...
        test_az_profile = (
            self.operator_cloud.load_balancer.create_availability_zone_profile(
        ...
        amphorae = self.operator_cloud.load_balancer.amphorae(
    ...
    def tearDown(self):
        ...
        self.operator_cloud.load_balancer.delete_quota(
        ...
        self.operator_cloud.load_balancer.delete_l7_policy(
        ...
        self.operator_cloud.load_balancer.delete_health_monitor(
        ...
        self.operator_cloud.load_balancer.delete_pool(
            self.POOL_ID, ignore_missing=False
        )
        self.operator_cloud.load_balancer.wait_for_load_balancer(
            self.LB_ID, wait=self._wait_for_timeout
        )

        self.operator_cloud.load_balancer.delete_listener(
        ...
        self.operator_cloud.load_balancer.delete_load_balancer(
            self.LB_ID, ignore_missing=False
        )
        super().tearDown()

        self.operator_cloud.load_balancer.delete_flavor(
    ...
    def test_lb_get(self):
        test_lb = self.operator_cloud.load_balancer.get_load_balancer(
            self.LB_ID
        )
        self.assertEqual(self.LB_NAME, test_lb.name)
        self.assertEqual(self.LB_ID, test_lb.id)
    ...
    def test_lb_get_stats(self):
        test_lb_stats = (
            self.operator_cloud.load_balancer.get_load_balancer_statistics(
                self.LB_ID
            )
        )
    ...
    def test_lb_list(self):
        names = [
            lb.name
            for lb in self.operator_cloud.load_balancer.load_balancers()
        ]
        self.assertIn(self.LB_NAME, names)

    def test_lb_update(self):
        self.operator_cloud.load_balancer.update_load_balancer(
    ...
    def test_listener_get(self):
        test_listener = self.operator_cloud.load_balancer.get_listener(
            self.LISTENER_ID
        )
        self.assertEqual(self.LISTENER_NAME, test_listener.name)
        self.assertEqual(self.LISTENER_ID, test_listener.id)
    ...
    def test_listener_get_stats(self):
        test_listener_stats = (
            self.operator_cloud.load_balancer.get_listener_statistics(
                self.LISTENER_ID
            )
        )
    ...
    def test_listener_list(self):
        names = [
            ls.name for ls in self.operator_cloud.load_balancer.listeners()
        ]
    ...
    def test_listener_update(self):
        ...
        self.operator_cloud.load_balancer.update_listener(
    ...
    def test_pool_list(self):
        names = [
            pool.name for pool in self.operator_cloud.load_balancer.pools()
        ]
    ...
    def test_pool_update(self):
        ...
        self.operator_cloud.load_balancer.update_pool(
        ...
        self.operator_cloud.load_balancer.update_pool(
            self.POOL_ID, name=self.POOL_NAME
        )
        self.operator_cloud.load_balancer.wait_for_load_balancer(
            self.LB_ID, wait=self._wait_for_timeout
        )
    ...
    def test_member_get(self):
        test_member = self.operator_cloud.load_balancer.get_member(
    ...
    def test_member_list(self):
        names = [
            mb.name
            for mb in self.operator_cloud.load_balancer.members(self.POOL_ID)
        ]
    ...
    def test_health_monitor_get(self):
        test_hm = self.operator_cloud.load_balancer.get_health_monitor(
            self.HM_ID
        )
        self.assertEqual(self.HM_NAME, test_hm.name)
        self.assertEqual(self.HM_ID, test_hm.id)
    ...
    def test_health_monitor_list(self):
        names = [
            hm.name
            for hm in self.operator_cloud.load_balancer.health_monitors()
        ]
    ...
    def test_health_monitor_update(self):
        ...
        self.operator_cloud.load_balancer.update_health_monitor(
    ...
    def test_l7_policy_get(self):
        test_l7_policy = self.operator_cloud.load_balancer.get_l7_policy(
            self.L7POLICY_ID
        )
    ...
    def test_l7_policy_list(self):
        names = [
            l7.name for l7 in self.operator_cloud.load_balancer.l7_policies()
        ]
    ...
    def test_l7_rule_list(self):
        ids = [
            l7.id
            for l7 in self.operator_cloud.load_balancer.l7_rules(
                l7_policy=self.L7POLICY_ID
            )
        ]
    ...
    def test_quota_get(self):
        test_quota = self.operator_cloud.load_balancer.get_quota(
            self.PROJECT_ID
        )
        self.assertEqual(self.PROJECT_ID, test_quota.id)
    ...
    def test_quota_update(self):
        ...
        for project_quota in self.operator_cloud.load_balancer.quotas():
            self.operator_cloud.load_balancer.update_quota(
                project_quota, **attrs
            )
            new_quota = self.operator_cloud.load_balancer.get_quota(
    ...
    def test_provider_flavor_capabilities(self):
        capabilities = (
            self.operator_cloud.load_balancer.provider_flavor_capabilities(
                self.AMPHORA
            )
        )
    ...
    def test_flavor_profile_get(self):
        test_flavor_profile = (
            self.operator_cloud.load_balancer.get_flavor_profile(
    ...
    def test_flavor_profile_list(self):
        names = [
            fv.name
            for fv in self.operator_cloud.load_balancer.flavor_profiles()
        ]
    ...
    def test_flavor_get(self):
        test_flavor = self.operator_cloud.load_balancer.get_flavor(
            self.FLAVOR_ID
        )
        self.assertEqual(self.FLAVOR_NAME, test_flavor.name)
        self.assertEqual(self.FLAVOR_ID, test_flavor.id)
    ...
    def test_flavor_update(self):
        self.operator_cloud.load_balancer.update_flavor(
    ...
    def test_amphora_list(self):
        amp_ids = [
            amp.id for amp in self.operator_cloud.load_balancer.amphorae()
        ]
    ...
    def test_amphora_get(self):
        test_amphora = self.operator_cloud.load_balancer.get_amphora(
            self.AMPHORA_ID
        )
        self.assertEqual(self.AMPHORA_ID, test_amphora.id)
    ...
    def test_amphora_configure(self):
        ...
        test_amp = self.operator_cloud.load_balancer.get_amphora(
            self.AMPHORA_ID
        )
    ...
    def test_availability_zone_get(self):
        test_availability_zone = (
            self.operator_cloud.load_balancer.get_availability_zone(
                self.AVAILABILITY_ZONE_NAME
            )
        )
        self.assertEqual(
    ...
    def test_availability_zone_list(self):
        names = [
            az.name
            for az in self.operator_cloud.load_balancer.availability_zones()
        ]
