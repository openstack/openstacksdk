...
class Proxy(proxy2.BaseProxy):
    def create_load_balancer(self, **attrs):
        ...
        :rtype: :class:`~openstack.load_balancer.v1.load_balancer.
                            LoadBalancerJob`
        """
        return self._create(_lb.LoadBalancerJob, **attrs)
    ...
    def update_load_balancer(self, load_balancer, **attrs):
        ...
        :rtype: :class:`~openstack.load_balancer.v1.load_balancer.
                            LoadBalancerJob`
        """
        return self._update(_lb.LoadBalancerJob, load_balancer, **attrs)
    ...
    def load_balancers(self, **query):
        ...
        """
        # QianBiao.NG:: return all by default, no pagination support
